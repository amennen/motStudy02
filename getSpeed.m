...
for s = 1:length(subvec)
    behavioral_dir = [fileparts(which('mot_realtime01.m')) '/BehavioralData/' num2str(subvec(s)) '/'];
    fileSpeed = dir(fullfile(behavioral_dir, ['mot_realtime01_' num2str(subvec(s)) '_' num2str(MOT_PREP)  '*.mat']));
